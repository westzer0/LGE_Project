...
def create_sequence_and_insert():
    """시퀀스 생성 및 답변 선택지 추가"""
    print("=" * 60)
    print("시퀀스 생성 및 답변 선택지 추가")
    print("=" * 60)
        ...
        with conn.cursor() as cur:
            try:
                cur.execute("""
                    ...
                    NOCACHE
                """)
                print("  ✓ SEQ_ONBOARDING_ANSWER 시퀀스 생성 완료")
                    ...
                    if exists == 0:
                        ...
                        cur.execute("""
                            INSERT INTO ONBOARDING_ANSWER (
                                ...
                                :answer_id, :q_code, :answer_value, SYSDATE
                            )
                        """, {
                            'answer_id': next_id,
                            'q_code': q_code,
