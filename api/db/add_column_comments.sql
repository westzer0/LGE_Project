...
COMMENT ON TABLE TASTE_CONFIG IS 'Taste별 추천 설정 관리 테이블 (1-1920개의 Taste ID별 설정)';

COMMENT ON COLUMN TASTE_CONFIG.TASTE_ID IS 'Taste ID (1-1920 범위, PRIMARY KEY)';
...
COMMENT ON COLUMN MEMBER.TASTE IS '할당된 Taste ID (1-1920 범위, NULL 가능)';
